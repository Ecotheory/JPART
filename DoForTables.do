...
*== Table 2: Baseline Results for SO2 Data Manipulation ==*
	...
	reg2docx m1 m2 m3 m4 m5 m6 m7 m8 m9 using "result/Tables.docx", append indicate("Year FE=yfe" "City FE=cfe") drop() scalars(r2_a(%9.3f) N_clust N) b(%9.3f) se(%7.3f) title("Table 2: Baseline Results for SO2 Data Manipulation")
...
*== Table 3: The Impact of Connections to Provincial Environmental Administrators ==*
	...
	reg2docx m1 m2 m3 m4 m5 m6 using "result/Tables.docx", append indicate("Economic Controls=ln_GDPper" "Population Controls=ln_Populatoin" "Weather Controls=Temperature" "Year FE=yfe" "City FE=cfe") drop(GDPgrowth Ratio_Second ln_Industry ln_Retail ln_Popdensity Precipitation Cloud _cons) scalars(r2_a(%9.3f) N_clust N) b(%9.3f) se(%7.3f) title("Table 3: The Impact of Connections to Provincial Environmental Administrators on Data Manipulation")
...
*== Table 4: The Impact of Age Effect ==*
	...
	reg2docx m1 m2 m3 using "result/Tables.docx", append indicate("Economic Controls=ln_GDPper" "Population Controls=ln_Populatoin" "Weather Controls=Temperature" "Year FE=yfe" "City FE=cfe") drop(GDPgrowth Ratio_Second ln_Industry ln_Retail ln_Popdensity Precipitation Cloud _cons) scalars(r2_a(%9.3f) N_clust N) b(%9.3f) se(%7.3f) title("Table 4: The Impact of Age Effect")
...
*== Table 6: Personal Characteristic Effect ==*
	...
	reg2docx m1 m2 m3 using "result/Tables.docx", append indicate("Economic Controls=ln_GDPper" "Population Controls=ln_Populatoin" "Weather Controls=Temperature" "Year FE=yfe" "City FE=cfe") drop(GDPgrowth Ratio_Second ln_Industry ln_Retail ln_Popdensity Precipitation Cloud _cons) scalars(r2_a(%9.3f) N_clust N) b(%9.3f) se(%7.3f) title("Table 6: Personal Characteristic Effect")
...
*== Table 7: Robustness Test of High Dimension FE ==*
	...
	reg2docx m1 m2 m3 using "result/Tables.docx", append indicate("Economic Controls=ln_GDPper" "Population Controls=ln_Populatoin" "Weather Controls=Temperature" "Year FE=yfe" "City FE=cfe" "Province×Year FE=ypfe") drop(GDPgrowth Ratio_Second ln_Industry ln_Retail ln_Popdensity Precipitation Cloud _cons) scalars(r2_a(%9.3f) N_clust N) b(%9.3f) se(%7.3f) title("Table 7: Robustness Test of High FE")
...
*== Table 8: Other Types of Connections ==*
	...
	reg2docx m1 m2 m3 m4 m5 m6 m7 m8 m9 using "result/Tables.docx", append indicate("Economic Controls=ln_GDPper" "Population Controls=ln_Populatoin" "Weather Controls=Temperature" "Year FE=yfe" "City FE=cfe") drop(GDPgrowth Ratio_Second ln_Industry ln_Retail ln_Popdensity Precipitation Cloud _cons) scalars(r2_a(%9.3f) N_clust N) b(%9.3f) se(%7.3f) title("Table 8: Other Types of Connections")
...
*== Table 5: Robustness Test by PM2.5 ==*	
	...
	reg2docx m1 m2 m3 using "result/Tables.docx", append indicate("Economic Controls=ln_GDPper" "Population Controls=ln_Populatoin" "Weather Controls=Temperature" "Province FE=pfe") drop(GDPgrowth Ratio_Second ln_Industry ln_Retail ln_Popdensity Precipitation Cloud _cons) scalars(r2_a(%9.3f) N_clust N) b(%9.3f) se(%7.3f) title("Table 5: Robustness Test by PM2.5")
